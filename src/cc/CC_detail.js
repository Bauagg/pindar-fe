...
const CCDetail = () => {
    ...
    const fetchdatas = async () => {
      ...
      const handleAjukan = (item) => {
        ...
        sessionStorage.setItem('imgdetail', `https://be.pindar.id/api${dataCC.imageLink}`);
                ...
                <div className="col-md-3 text-center">
                  <div className="card-detail">
                    ...
                    <div className="d-flex justify-content-between">
                      <div>
                        <h6 className="title-lexend">{ formatRupiah(dataCC.yearlyFee)}</h6>
                        <p>Iuran Tahunan</p>
                      </div>
                      <div>
                  ...
                  <button type="button" className="btn btn-detail-ajukan" onClick={() => handleAjukan(dataCC.directLink)}><b>Ajukan Sekarang</b></button>
                  </div>
                </div>
                  ...
                  <div className="accordion-wrapper">
                    <div className="accordion-section my-4">
                      ...
                      {openSection === 'detail' && (
                        <div className="accordion-content">
                          {dataCC.detailInformation || 'Tidak ada informasi.'}
                        </div>
                      )}
                    </div>
                    ...
                    <div className="accordion-section my-4">
                      ...
                      {openSection === 'features' && (
                        <div className="accordion-content">
                          {dataCC.mainFeature || 'Tidak tersedia'}
                        </div>
                      )}
                    </div>
                    ...
                    <div className="accordion-section my-4">
                      ...
                      {openSection === 'facilities' && (
                        <div className="accordion-content">
                          <ul>
                            {(dataCC.features && dataCC.features.length > 0) ? dataCC.features.map((f, i) => (
                              <li key={i}>{f}</li>
                    ...
                    <div className="accordion-section my-4">
                      ...
                      {openSection === 'fees' && (
                        <div className="accordion-content">
                          <p><b>Iuran Tahunan:</b> {formatRupiah(dataCC.yearlyFee)}</p>
                          <p><b>Biaya Tambahan Kartu:</b> {formatRupiah(dataCC.additionalCardAnnualFee)}</p>
                          <p><b>Bunga Pembelian:</b> {dataCC.purchaseRate}%</p>
                          <p><b>Cashback:</b> {dataCC.cashbackRate}%</p>
                          <p><b>Denda Telat Bayar:</b> {dataCC.latePaymentChargePenalty}</p>
                          <p><b>Biaya Admin Telat Bayar:</b> {dataCC.latePaymentAdminCharge}</p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="accordion-section my-4">
                      ...
                      {openSection === 'requirements' && (
                        <div className="accordion-content">
                          <p><b>Pendapatan Bulanan Minimum:</b> {formatRupiah(dataCC.monthlyIncomeMinimum)}</p>
                          <p><b>Pendapatan Tahunan Minimum:</b> {formatRupiah(dataCC.yearlyIncomeMinimum)}</p>
                          <p><b>Usia Minimum Kartu Utama:</b> {dataCC.mainCardMinimumAge}</p>
                          <p><b>Usia Maksimum Kartu Utama:</b> {dataCC.mainCardMaximumAge}</p>
                          <p><b>Usia Minimum Kartu Tambahan:</b> {dataCC.additionalCardMinimumAge}</p>
                        </div>
                      )}
                    </div>
