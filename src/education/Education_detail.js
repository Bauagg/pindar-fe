            ...
            <div className="container detail-page py-4">
              <div className="row">
                <div className="col-sm-8 mx-auto text-center">
                    <img
                        src={dataEducation.imageLink ? `https://be.pindar.id/api${dataEducation.imageLink}` : "https://placehold.co/600x400"}
                        className="img-fluid mb-2"
                        alt={dataEducation.title}
                        style={{borderRadius: '24px', maxheight: '434px'}}
                    />        
                    <div className="text-muted small"><i className="bi bi-clock"></i> {formatDate(dataEducation.createdDate)}</div>
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <div>
                            <div className="small text-muted mb-1">{dataEducation.categoryName}</div>        
                        </div>
                    </div>
                    <div className="my-4">
